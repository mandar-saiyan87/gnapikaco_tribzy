    ...
    <div className='w-full max-w-[1848px] bg-herobg mx-auto'>
      ...
      <div className='flex flex-col-reverse my-10 md:gap-y-10 lg:justify_center lg:flex-row xl:gap-x-10'>
        ...
        <div className='flex flex-col items-center text-center'>
          ...
          <p className='text-lg leading-10 text-sectext font-bold italic md:text-4xl md:leading-[50px] lg:text-5xl xl:text-6xl xl:leading-[70px]'>Tribsy</p>
        </div>
      </div>
      <div className='flex items-center justify-center'>
        <div className='bg-mainbg max-w-max rounded-t-xl px-14 pt-2 md:pt-4 md:px-28 lg:px-28 lg:pt-7 xl:px-36'>
